...
try:
    ...
    my_addin.add_command(
        ...
        SamplePaletteShowCommand,
        {
            ...
            'palette_html_file_url': os.path.join('commands', 'palette_html', 'Auto GitHub Exporter.html'),
    ...
    # my_addin.add_document_event("Auto GitHub Exporter_close_event", app.documentClosed, SampleDocumentEvent2)
    # my_addin.add_workspace_event("Auto GitHub Exporter_workspace_event", ui.workspaceActivated, SampleWorkspaceEvent)
