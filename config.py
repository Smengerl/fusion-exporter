...
EXPORT_FULL_ZSB_KEY = 'export_full_zsb'
EXPORT_FULL_ZSB_NAME_KEY = 'export_full_zsb_name'
ROOT_COMPONENT_NAME_KEY = 'root_component_name'
...
EXPORT_FULL_ZSB_DEFAULT_VALUE = True
EXPORT_FULL_ZSB_NAME_DEFAULT_VALUE = 'full'
ROOT_COMPONENT_NAME_DEFAULT_VALUE = 'root'
